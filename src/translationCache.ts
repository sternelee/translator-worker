...

{
  ...
  translationCache.google.get = (source, targetLanguage) =>
    translationCache.get("google", source, targetLanguage);

  translationCache.yandex.get = (source, targetLanguage) =>
    translationCache.get("yandex", source, targetLanguage);

  translationCache.bing.get = (source, targetLanguage) =>
  ...
  translationCache.google.set = (source, translated, targetLanguage) =>
    translationCache.set("google", source, translated, targetLanguage);

  translationCache.yandex.set = (source, translated, targetLanguage) =>
    translationCache.set("yandex", source, translated, targetLanguage);

  translationCache.bing.set = (source, translated, targetLanguage) =>
